...
public class TargetTests {
	...
	public void testTargets0_23_3() //tests upper right corner
	{
		...
		Assert.assertTrue(targets.contains(board.getCell(0, 21)));//
	...
	public void testTargetsLeavingRoom(){
		...
		Set<BoardCell> targets = board.getTargets();
		Assert.assertEquals(2, targets.size());
		Assert.assertTrue(targets.contains(board.getCell(6, 16)));
		Assert.assertTrue(targets.contains(board.getCell(6, 20)));
		cell = board.getCell(7, 7);
		board.calcTargets(cell, 6);
		targets = board.getTargets();
		Assert.assertEquals(16, targets.size());
		Assert.assertTrue(targets.contains(board.getCell(2, 8)));
		Assert.assertTrue(targets.contains(board.getCell(4, 8)));
		Assert.assertTrue(targets.contains(board.getCell(6, 8)));
		Assert.assertTrue(targets.contains(board.getCell(8, 8)));
		Assert.assertTrue(targets.contains(board.getCell(10, 8)));
		Assert.assertTrue(targets.contains(board.getCell(12, 8)));
		Assert.assertTrue(targets.contains(board.getCell(3, 9)));
		Assert.assertTrue(targets.contains(board.getCell(5, 9)));
		Assert.assertTrue(targets.contains(board.getCell(7, 9)));
		Assert.assertTrue(targets.contains(board.getCell(9, 9)));
		Assert.assertTrue(targets.contains(board.getCell(11, 9)));
		Assert.assertTrue(targets.contains(board.getCell(4, 10)));
		Assert.assertTrue(targets.contains(board.getCell(6, 10)));
		Assert.assertTrue(targets.contains(board.getCell(8, 10)));
		Assert.assertTrue(targets.contains(board.getCell(10, 10)));
